...
import { createFile} from '../../../redux/fileFoldersActionCreator';
...
const checkFileAlreadyPresent = (name, ext) => {
    ...
    const filePresent = userFiles.filter(
...
dispatch(createFile(data, setSuccess));
            ...
            alert(fileName + " Created Sucessfully");   
            } else{
...
<div className='d-flex flex-column align-items-center'>
    <form className='mt-3 w-100' onSubmit={handleSubmit}>
        <div className='form-group'>
            ...
            id='folderName'
            placeholder='File Name e.g file.txt, index.php, index.html' 
            value = {fileName}
